...
const YoutubeSub = () => {
    ...
    useEffect(() => {
        ...
        document.getElementById('media-sub').value = ` 0:00
    ...
    useEffect(() => {
        if(_.isEmpty(arrSub)){
            document.getElementById('sub-control').style.display = "none";
        }else{
            document.getElementById('sub-control').style.display = "block";
        }                                                                                                                                                                                                                                   
    }, [arrSub]);
    ...
    const onClickSub = (time, value) => {
        ...
        console.log(`sub-item${time}`);
        console.log(document.getElementById(`sub-item${time}`).style);
        document.getElementById(`sub-item${time}`).style.backgroundColor = "#ff0000";
        clearInterval(interval);
        console.log("interval:"+interval +" has been clear!");
        ...
        player.seekTo(timestart, true);
            ...
            interval = setInterval(() => {
                ...
                // console.log("currTime:"+currTime);
                 console.log("nextTime:"+nextTime.toString()+" - currTime:"+currTime);
                if (_.isEqual(currTime, nextTime.toString()) && isReplay === true) {
                    console.log("replay at:"+timestart);
                    player.seekTo(timestart, true)
                }
            }, 1000);
